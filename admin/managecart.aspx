...
<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.master" AutoEventWireup="true" CodeFile="managecart.aspx.cs" Inherits="admin_managereview" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
       <asp:GridView ID="gvcartdetails" runat="server" AutoGenerateColumns="false" Width="600px"
                      ...
                      PagerStyle-CssClass="pgr" OnRowCommand="gvcartdetails_RowCommand" OnPageIndexChanging="gvcartdetails_PageIndexChanging1" >
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Product_name">
                        ...
                        <ItemTemplate>
                            <asp:LinkButton ID="LinkButton1" runat="server"  CommandName="remove" CssClass="btnlogin">Remove</asp:LinkButton>
                        </ItemTemplate>
