<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.master" AutoEventWireup="true" CodeFile="state.aspx.cs" Inherits="city" %>
          ...
          <AlternatingRowStyle BackColor="White" />
           ...
           <Columns>
               <asp:TemplateField HeaderText="State_Id">
                   <ItemTemplate>
                       <asp:Label ID="lnsid" runat="server" Text='<%# Bind("s_id") %>'></asp:Label>
                   </ItemTemplate>
               </asp:TemplateField>
               <asp:TemplateField HeaderText="State_name">
                   <ItemTemplate>
                        <asp:Label ID="lnconname" runat="server" Text='<%# Bind("sname") %>'></asp:Label>
                   </ItemTemplate>
               </asp:TemplateField>
