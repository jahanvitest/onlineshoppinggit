<%@ Page Title="" Language="C#" MasterPageFile="~/user pages/user.master" AutoEventWireup="true" CodeFile="v_product.aspx.cs" Inherits="v_product" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:DataList ID="dbproduct" runat="server" BackColor="Gray" 
            ...
            Font-Names="Verdana" Font-Size="Small" GridLines="Both" DataKeyField="product_id" RepeatColumns="5" RepeatDirection="Horizontal"
            Width="1350px" OnItemCommand="dbproduct_ItemCommand" OnSelectedIndexChanged="dbproduct_SelectedIndexChanged" CaptionAlign="Top">
        <HeaderTemplate>
            <h1>Products</h1>
        </HeaderTemplate>
